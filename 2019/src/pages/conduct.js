...
export default () => (
  <Container title="Conduct">
    ...
    <Text mb={4}>
      Participants will be provided with contact information to reach conference
      staff who will be happy help participants contact hotel/venue security or
    ...
    <Text mb={4}>
      Organizers will enforce this code throughout the event, and can be reached
      at <Link href="mailto:nvlatko@wayfair.com">nvlatko@wayfair.com</Link>, or
